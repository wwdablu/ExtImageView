...
public class DisplayBitmapCropper implements Runnable {
    ...
    public DisplayBitmapCropper(@NonNull Bitmap displayBitmap,
    ...
    public void run() {
        ...
        try {
            ...
            Bitmap croppedAndCorrected = trapezoidToRectangleTransform(pathBound);
    ...
    private Bitmap trapezoidToRectangleTransform(RectF bounds) {
